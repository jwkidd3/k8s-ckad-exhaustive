...
This exercise verifies your comfortability-level with API deprecations and how to handle them appropriately. If you are trying to create both objects with Kubernetes 1.26, you will find that the API version `apps/v1beta2` assigned to the Deployment definition cannot be found.
